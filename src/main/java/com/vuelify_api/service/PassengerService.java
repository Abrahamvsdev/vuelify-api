...
public class PassengerService {
    ...
    public @NonNull
    Passenger getPassengerById(@NonNull UUID id) {
        return passengerRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Passenger not found with ID: " + id)); //TODO Must change when organice exceptions)
    }

    @Transactional(readOnly = true)
    public @NonNull
    Passenger getPassengerByPassport(@NonNull String passportNumber) {
